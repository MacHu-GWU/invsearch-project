# -*- coding: utf-8 -*-
#
# invsearch documentation build configuration file, created by
...
version = invsearch.__version__
# The full version, including alpha/beta/rc tags.
release = invsearch.__version__
...
html_logo = "./_static/invsearch-logo.png"
html_favicon = "./_static/invsearch-favicon.ico"
...
htmlhelp_basename = 'invsearchdoc'
...
latex_documents = [
    (master_doc, 'invsearch.tex', 'invsearch Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'invsearch', 'invsearch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'invsearch', 'invsearch Documentation',
     author, 'invsearch', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from invsearch.docs import doc_data
except:
    doc_data = dict()
...
package_name = invsearch.__name__
